<?php
    ...
    passion_add_body_class('user-public-profile');
...
<div id="item-content">
    <div class="user-card">
        <img src="<?php echo osc_current_web_theme_url('images/user_default.png') ; ?>" />
        <ul id="user_data">
    ...
    <h2><?php _e('User description', 'passion'); ?></h2>
    <?php } ?>
    <?php echo nl2br(osc_user_info()); ?>
    <?php if( osc_count_items() > 0 ) { ?>
    <div class="similar_ads">
        <h2><?php _e('Latest listings', 'passion'); ?></h2>
