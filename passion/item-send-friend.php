<?php
    ...
    passion_add_body_class('contact');
    osc_current_web_theme_path('header.php');
?>
<div class="form-container form-horizontal form-container-box">
    <div class="header">
        <h1><?php _e('Send to a friend', 'passion'); ?></h1>
    </div>
    <div class="resp-wrapper">
        ...
        <form name="sendfriend" action="<?php echo osc_base_url(true); ?>" method="post" >
            ...
            <div class="control-group">
                <label class="control-label" for="yourEmail"><?php _e("Your e-mail",'passion'); ?></label>
                <div class="controls ">
            ...
            <?php } ?>
            <div class="control-group">
                <label class="control-label" for="friendName"><?php _e("Your friend's name",'passion'); ?></label>
                <div class="controls">
                    <?php SendFriendForm::friend_name(); ?>
                </div>
            </div>
            <div class="control-group">
                <label for="friendEmail"><?php _e("Your friend's e-mail address", 'passion'); ?></label> </label>
                <div class="controls">
            ...
            <div class="control-group">
                <label class="control-label" for="subject">
                    <?php _e('Subject (optional)', 'passion'); ?>
                </label>
                <div class="controls">
