...
<?php
    $js_lang = array(
        'delete' => __('Delete', 'passion'),
        'cancel' => __('Cancel', 'passion')
    );
...
<script type="text/javascript">
    var passion = window.passion || {};
    passion.base_url = '<?php echo osc_base_url(true); ?>';
    passion.langs = <?php echo json_encode($js_lang); ?>;
    passion.fancybox_prev = '<?php echo osc_esc_js( __('Previous image','passion')) ?>';
    passion.fancybox_next = '<?php echo osc_esc_js( __('Next image','passion')) ?>';
    passion.fancybox_closeBtn = '<?php echo osc_esc_js( __('Close','passion')) ?>';
</script>
<link href="<?php echo osc_current_web_theme_url('css/bootstrap/css/bootstrap.min.css') ; ?>" rel="stylesheet" type="text/css" />
...
<link href="<?php echo osc_current_web_theme_url('css/responsive.css') ; ?>" rel="stylesheet" type="text/css" />
